...
class AniListService:
    ...
    async def search_anime(self, search: str, limit: int = 10) -> List[Dict]:
        ...
        if data and 'Page' in data:
            ...
            for media in data['Page']['media']:
                ...
                display_title = title_eng or title_rom or 'Unknown'
                results.append({
                    'id': media['id'],
                    'title': display_title,
    ...
    async def get_trending(self, limit: int = 10) -> List[Dict]:
        """Alias for get_trending_anime"""
        return await self.get_trending_anime(per_page=limit)

    async def get_seasonal(self, limit: int = 10) -> List[Dict]:
        """Alias for get_seasonal_anime"""
        return await self.get_seasonal_anime()
